...
path.test_path = '/home/lab530/KenYu/visualDet3D/kitti/testing_toy' # "/data/kitti_obj/testing" # used in visualDet3D/data/.../dataset
...
path.project_path = '/home/lab530/KenYu/visualDet3D/toy_baseline_exp' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
data = edict(
    ...
    train_split_file = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'toy_split', 'train.txt'),
    val_split_file   = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'toy_split', 'val.txt'),
)

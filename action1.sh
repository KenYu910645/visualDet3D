...
# ./launchers/train.sh config/nuscene_kitti.py 1 nuscene_kitt
...
# ./launchers/eval.sh config/nuscene_kitti.py 1 /home/lab530/KenYu/visualDet3D/exp_output/nuscene_kitti/Mono3D/checkpoint/GroundAwareYolo3D_latest.pth validation
